...
| 文件 | 内容 |
|------|------|
| [[01-核心App]] | App 结构、生命周期、Option 模式 |
| [[02-Server接口]] | Server 接口定义 + Gin HTTP 实现 + Hello 实现 |
| [[03-FX集成]] | FX Module 装配与依赖注入 |
| [[04-使用指南]] | **面向业务开发者：快速上手、配置、最佳实践** |
...
详细讨论见 [[../../架构决策/未来优化/01-App生命周期钩子|App 生命周期钩子优化]]。
