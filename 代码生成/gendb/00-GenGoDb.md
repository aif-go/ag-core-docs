...
| # | 文档 | 说明 | 面向读者 |
|---|------|------|---------|
| 01 | [[01-Excel解析架构\|Excel 解析架构]] | Excel 模板的区域识别、数据模型、自定义脚本解析 | 维护者 |
| 02 | [[02-WHERE条件解析器\|WHERE 条件解析器]] | 词法分析器 + 语法分析器设计，递归下降解析 | 维护者 |
| 03 | [[03a-YAML定义格式详解\\|表 YAML 定义格式详解]] | YAML 中间格式的完整字段说明、where 条件树、动态模板结构 | 维护者 · 业务开发者 |
| 04 | [[04-Model代码生成引擎\|Model 代码生成引擎]] | YAML → Go Model 的完整流水线，GORM tag，index guard | 维护者 |
| 05 | [[05-DAO代码生成引擎\|DAO 代码生成引擎]] | DAO CRUD + 命名 SQL + 数据库特化代码生成 | 维护者 |
| 06 | [[06-使用指南\|使用指南]] | 从 Excel 模板到运行代码的完整操作流程 | 业务开发者 |
